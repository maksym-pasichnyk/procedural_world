...
struct Shader {
	...
	static GLuint load(const std::string &vertex_file_path, const std::string &fragment_file_path);

	static GLuint create(const std::string &vertex_source, const std::string &fragment_source, const std::string& geometry_source);
	static GLuint load(const std::string &vertex_file_path, const std::string &fragment_file_path, const std::string& geometry_file_path);

...
struct perlin3d {
	...
	static constexpr const int perm[512] {
	...
	static double noise(const glm::vec3& point);

	static double noise(const glm::vec3& point, int octaves, float persistence = 0.5f);
};